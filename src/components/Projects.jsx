...
function Projects() {
    ...
    return (
        <>
            {/* Desktop Section */}
            <div ref={ref} className='max-lg:hidden max-md:hidden w-screen h-[160vh] overflow-hidden flex flex-col items-center bg-black'>
                {inView &&
                    <>
            ...
            {/* Tablet Section */}
            <div ref={tabRef} className='max-md:hidden lg:hidden w-screen h-[140vh] overflow-hidden flex flex-col items-center bg-black'>
                {inTabView &&
                    <>
            ...
            {/* Mobile Section */}
            <div ref={mobRef} className='md:hidden w-screen h-[220vh] overflow-hidden flex flex-col items-center bg-black'>
                {inMobView &&
                    <>
