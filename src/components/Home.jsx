            ...
            {inView && 
                <>
                    ...
                    <div className='bio absolute flex flex-col top-[15vh] pl-[10vw] w-[60vw] h-[72vh] gap-[2vh] overflow-hidden'>
                        <div className='intro text-white text-[2.5vh]'>Hello, My Name is</div>
                        <div className='Name text-white font-semibold text-[8vh] pr-[1vw] pb-[1vh] -mt-[3vh]'>{Bio.Name}</div>
                        <div className='pro flex gap-[1vw] text-[5vh] border-b-[0.005vh] border-purple-500 pb-[1vh] -mt-[1.5vh]'>
                            <div className='text-white'>I'm a</div>
                            <div className='type text-purple-500'><Typewriter /></div>
                        </div>
                        <div className="desc text-white mt-[1vh]">{Bio.desc}</div>
