...
const About: React.FC = () => {
  ...
  return (
    <>
      <div
        ref={ref}
        className="w-screen h-[90vh] relative overflow-hidden bg-black"
      >
        {/* Desktop Section */}
        {inView && (
          <>
              ...
              <div className="flex flex-col w-[50vw] gap-[2vh]">
                ...
                <div className="p-[2vh] -ml-[2vh] h-[15vh]  overflow-hidden">
                  <Link
                    ...
                    offset={-78}
                  >
                    <button className="read-btn text-[2.5vh] text-purple-600 hover:text-purple-400 shadow-md shadow-purple-400 hover:text-[2.7vh] h-[7.8vh] w-[160px] rounded-full border-[0.3vh] border-purple-700 duration-300 hover:shadow-lg hover:shadow-purple-500 hover:translate-x-[0.2vw] hover:translate-y-[0.2vw]">
                      Read More
                    </button>
                  </Link>
                </div>
              ...
              <div className="flex flex-col w-[50vw] gap-[2vh]">
                ...
                <div className="p-[2vh] -ml-[2vh] h-[15vh]  overflow-hidden">
                  <Link
                    ...
                    offset={-78}
                  >
                    <button className="read-btn text-[2.5vh] text-purple-600 hover:text-purple-400 shadow-md shadow-purple-400 hover:text-[2.7vh] h-[7.8vh] w-[150px] rounded-full border-[0.3vh] border-purple-700 duration-300 hover:shadow-lg hover:shadow-purple-500 hover:translate-x-[0.2vw] hover:translate-y-[0.2vw]">
                      Read More
                    </button>
                  </Link>
                </div>
              ...
              <div className="flex flex-col gap-[1.5vh] w-[80vw]">
                ...
                <div className="p-[2vh] -ml-[2vh] h-[15vh] -mt-[2vh] overflow-hidden">
                  <Link
                    ...
                    offset={-78}
                  >
                    <button className="read-btn text-[2.3vh] text-purple-600 hover:text-purple-400 shadow-md shadow-purple-400 hover:text-[2.5vh] h-[7vh] w-[130px] rounded-full border-[0.3vh] border-purple-700 duration-300 hover:shadow-lg hover:shadow-purple-500 hover:translate-x-[0.2vw] hover:translate-y-[0.2vw]">
                      Read More
                    </button>
                  </Link>
                </div>
